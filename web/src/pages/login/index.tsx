  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-indigo-50 text-slate-800 font-sans overflow-x-hidden">
      ...
      <div className="fixed -z-10 inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/3 right-10 w-80 h-80 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-40 h-40 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse"
        ...
        >
          <div className="max-w-lg">
            ...
            <div className="flex items-center mb-10">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center text-white font-bold text-xl">
                G
              </div>
              <span className="ml-3 text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-800 to-slate-600">
                Gin-React-Admin
              </span>
            </div>
                  ...
                  {loginMethod === "code" ? (
                    ...
                    >
                      ...
                      <div className="flex justify-end">
                        <a
                          href="#"
                          className="text-sm text-cyan-600 hover:text-cyan-700 transition-colors hover:underline"
                        >
                          忘记密码?
                        </a>
                      </div>
